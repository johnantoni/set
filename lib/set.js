...
(function() {
  ...
  set = function(root, obj) {
    ...
    shouldRenderStatic = isRunningOnServer && obj.__set.renderStatic;
    ...
    qif = qdef.qif || "data-set-if";
    qrepeat = qdef.qrepeat || "data-set-repeat";
    qattr = qdef.qattr || "data-set-attribute";
    qtext = qdef.qtext || "data-set-text";
    qdup = qdef.qdup || "data-set-dummy";
    format = qdef.format;
    qdef = qdef.qdef || "data-set-alias";
